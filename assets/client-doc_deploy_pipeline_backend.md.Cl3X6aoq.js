import{_ as s,c as a,o as p,ae as l}from"./chunks/framework.Dh1jimFm.js";const _=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"client-doc/deploy/pipeline/backend.md","filePath":"client-doc/deploy/pipeline/backend.md","lastUpdated":1770358354000}'),e={name:"client-doc/deploy/pipeline/backend.md"};function i(c,n,t,o,d,r){return p(),a("div",null,n[0]||(n[0]=[l(`<h4 id="后端服务流水线" tabindex="-1">后端服务流水线 <a class="header-anchor" href="#后端服务流水线" aria-label="Permalink to &quot;后端服务流水线&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>pipeline {</span></span>
<span class="line"><span>  agent {</span></span>
<span class="line"><span>    node {</span></span>
<span class="line"><span>      label &#39;mavenjdk17&#39;</span></span>
...
<span class="line"><span>          branch: env.BRANCH_NAME, </span></span>
...
<span class="line"><span>          label &#39;base&#39;</span></span>
<span class="line"><span>        }</span></span>
<span class="line"><span>      }</span></span>
<span class="line"><span>      // 打jar包、镜像</span></span>
<span class="line"><span>      // 注意gitlab中./docker/dockerfile是否正确</span></span>
<span class="line"><span>      steps {</span></span>
...
<span class="line"><span>            sh &#39;mvn clean package -Dmaven.test.skip=true&#39;</span></span>
<span class="line"><span>            sh &#39;docker build -f ./docker/dockerfile -t $REGISTRY/$DOCKERHUB_NAMESPACE/$APP_NAME:SNAPSHOT-$BUILD_NUMBER .&#39;</span></span>
<span class="line"><span>            sh &#39;docker push  $REGISTRY/$DOCKERHUB_NAMESPACE/$APP_NAME:SNAPSHOT-$BUILD_NUMBER&#39;</span></span>
<span class="line"><span>          }</span></span>
<span class="line"><span>        }</span></span>
<span class="line"><span>      }</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>    // 推送镜像</span></span>
...
<span class="line"><span>      steps {</span></span>
<span class="line"><span>        container(&#39;maven&#39;) {</span></span>
<span class="line"><span>          sh &#39;docker tag  $REGISTRY/$DOCKERHUB_NAMESPACE/$APP_NAME:SNAPSHOT-$BUILD_NUMBER $REGISTRY/$DOCKERHUB_NAMESPACE/$APP_NAME:latest &#39;</span></span>
<span class="line"><span>          sh &#39;docker push  $REGISTRY/$DOCKERHUB_NAMESPACE/$APP_NAME:latest &#39;</span></span>
<span class="line"><span>        }</span></span>
<span class="line"><span>      }</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>    // 部署容器，注意gitlab地址下是否存在 deploy/deploy.yaml</span></span>
...
<span class="line"><span>            ]</span></span>
<span class="line"><span>          ) {</span></span>
<span class="line"><span>            sh &#39;envsubst &lt; deploy/deploy.yaml | kubectl apply -f -&#39;</span></span>
<span class="line"><span>          }</span></span>
<span class="line"><span>        }</span></span>
<span class="line"><span>      }</span></span>
<span class="line"><span>    }</span></span>
...
<span class="line"><span>    APP_NAME = &#39;enfi-manage&#39;</span></span>
<span class="line"><span>    BRANCH_NAME = &#39;manage&#39;</span></span>
<span class="line"><span>    GIT_URL = &#39;https://git.enfi.com.cn/in-project/scaffolding.git&#39;</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h4 id="" tabindex="-1"><a class="header-anchor" href="#" aria-label="Permalink to &quot;&quot;">​</a></h4>`,3)]))}const A=s(e,[["render",i]]);export{_ as __pageData,A as default};
